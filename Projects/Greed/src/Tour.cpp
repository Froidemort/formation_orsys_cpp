/* Debut de 'Home/Tour/Tour.cpp'
 * Denis Gillain - Version 1.2 - 23 gennaio 2018
 */
...
int Tour::nouveau_lancer(
	...
	// On ne peut pas faire un nouveau_lancer() si les des n'ont pas gagne au prealable
	// (il faut avoir fait un lancer)
	if ( points_du_tour == 0 )
		return 0 ;
